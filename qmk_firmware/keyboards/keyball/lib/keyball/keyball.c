...
__attribute__((weak)) void keyball_on_apply_motion_to_mouse_move(
    keyball_motion_t* m,
    report_mouse_t* r,
    bool is_left
) {
...
__attribute__((weak)) void keyball_on_apply_motion_to_mouse_scroll(
    keyball_motion_t* m,
    report_mouse_t* r,
    bool is_left
) {
...
static void rpc_get_info_handler(
    uint8_t in_buflen,
    const void* in_data,
    uint8_t out_buflen,
    void* out_data
...
static void rpc_get_info_invoke(void) {
    ...
    dprintf(
        "keyball:rpc_get_info_invoke: negotiated #%d %d\n",
        round,
...
static void rpc_get_motion_handler(
    uint8_t in_buflen,
    const void* in_data,
    uint8_t out_buflen,
    void* out_data
...
static void rpc_set_cpi_handler(
    uint8_t in_buflen,
    const void* in_data,
    uint8_t out_buflen,
    void* out_data
