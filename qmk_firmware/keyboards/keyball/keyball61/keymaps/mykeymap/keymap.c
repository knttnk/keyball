...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    ...
    XXXXXXX  , XXXXXXX  , KC_LWIN  , KC_LALT  , KK_MHEN_SCLN , KC_BTN1  , KC_BTN2  ,      MO(2)    , LT(3,JP_HENK) , XXXXXXX  , XXXXXXX  , XXXXXXX  , KC_RCTRL , TO(3)
  ),

  [1] = LAYOUT_universal(
    XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX , XXXXXXX  ,                                 XXXXXXX       , XXXXXXX  , JP_MINS  , JP_CIRC  , JP_YEN   , KC_DEL   ,
    _______  , XXXXXXX  , KC_PGUP  , XXXXXXX  , XXXXXXX , XXXXXXX  ,                                 XXXXXXX       , XXXXXXX  , XXXXXXX  , JP_AT    , JP_LBRC  , XXXXXXX  ,
    _______  , KC_HOME  , KC_PGDN  , KC_END   , XXXXXXX , XXXXXXX  ,                                 XXXXXXX       , XXXXXXX  , JP_SCLN  , JP_COLN  , JP_RBRC  , _______  ,
    _______  , XXXXXXX  , KC_INS   , XXXXXXX  , XXXXXXX , XXXXXXX  , _______  ,           XXXXXXX  , XXXXXXX       , JP_COMM  , JP_DOT   , JP_SLSH  , JP_BSLS  , _______  ,
  ...
  [2] = LAYOUT_universal(     
    ...
    _______  , KC_F11   , KC_F12   , XXXXXXX  , XXXXXXX  , XXXXXXX  ,                                XXXXXXX       , KC_BRIU  , KC_VOLU  , XXXXXXX  , XXXXXXX  , _______  ,
    _______  , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  ,                                XXXXXXX       , KC_BRID  , KC_VOLD  , XXXXXXX  , XXXXXXX  , _______  ,
...
// 編集
uint32_t last_KK_MHEN_SCLN_pressed;
bool scrolling =
