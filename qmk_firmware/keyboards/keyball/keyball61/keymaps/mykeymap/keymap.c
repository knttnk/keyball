...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    KC_ESC   , KC_1     , KC_1     , KC_1     , KC_1     , KC_1     ,                                  KC_6     , KC_7     , KC_8     , KC_8     , KC_0     , KC_MINS  ,
  ...
  [1] = LAYOUT_universal(
    S(KC_ESC), S(KC_1)  , KC_LBRC  , S(KC_3)  , S(KC_4)  , S(KC_5)  ,                                  KC_EQL   , S(KC_8)  ,S(KC_QUOT), S(KC_8)  , S(KC_8)  ,S(KC_INT1),
